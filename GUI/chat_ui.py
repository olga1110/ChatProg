...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.mode_textBrowser = QtWidgets.QTextBrowser(Form)
        self.mode_textBrowser.setGeometry(QtCore.QRect(640, 50, 141, 31))
        ...
        self.send_button.setGeometry(QtCore.QRect(700, 100, 71, 61))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(690, 480, 93, 41))
        self.pushButton_2.setObjectName("pushButton_2")
        self.label_5 = QtWidgets.QLabel(Form)
        self.label_5.setGeometry(QtCore.QRect(500, 20, 131, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.user_textBrowser = QtWidgets.QTextBrowser(Form)
        self.user_textBrowser.setGeometry(QtCore.QRect(640, 10, 141, 31))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Режим:"))
        self.mode_textBrowser.setPlaceholderText(_translate("Form", "На чтение/на запись"))
